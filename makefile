...
test:
	$(BINDIR)/COR 127.0.0.1 59030

test1:
	$(BINDIR)/COR 127.0.0.1 59031

test2:
	$(BINDIR)/COR 127.0.0.1 59032
	
test3:
	$(BINDIR)/COR 127.0.0.1 59033

test4:
	$(BINDIR)/COR 127.0.0.1 59034

test5:
	$(BINDIR)/COR 127.0.0.1 59035
