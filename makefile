...
test:
	$(BINDIR)/COR 127.0.0.1 50010

test1:
	$(BINDIR)/COR 127.0.0.1 50011

test2:
	$(BINDIR)/COR 127.0.0.1 50012
	
test3:
	$(BINDIR)/COR 127.0.0.1 50013

test4:
	$(BINDIR)/COR 127.0.0.1 50014

test5:
	$(BINDIR)/COR 127.0.0.1 50015
