...
test:
	$(BINDIR)/COR 127.0.0.1 50000

test1:
	$(BINDIR)/COR 127.0.0.1 50001

test2:
	$(BINDIR)/COR 127.0.0.1 50002
	
test3:
	$(BINDIR)/COR 127.0.0.1 50003

test4:
	$(BINDIR)/COR 127.0.0.1 50004

test5:
	$(BINDIR)/COR 127.0.0.1 50005
