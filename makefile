...
test:
	$(BINDIR)/COR 127.0.0.1 50060

test1:
	$(BINDIR)/COR 127.0.0.1 50061

test2:
	$(BINDIR)/COR 127.0.0.1 50062
	
test3:
	$(BINDIR)/COR 127.0.0.1 50063

test4:
	$(BINDIR)/COR 127.0.0.1 50064

test5:
	$(BINDIR)/COR 127.0.0.1 50065
